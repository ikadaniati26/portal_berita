...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Data Berita Utama</h3>
                    ...
                    <div class="modal fade" id="artikelModal" tabindex="-1" aria-labelledby="artikelModalLabel"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content" width="100px">
                                ...
                                <form action="{{ route('tambahBeritaUtama') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="artikel_idartikel" id="selectArticle" />
                                    
                                    <!-- Tambahkan input hidden untuk artikel yang dipilih -->
                                    <button type="submit" class="btn btn-primary">Tambahkan ke Berita Utama</button>
                                </form>
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="basic-datatables" class="table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->editor}}</td>
                                        <td>
                                            <form method="POST" action="{{ route('hapus_berita',['id'=>$item->idberitautama])}}">
                                                @csrf
                                                @method('DELETE')
                                                {{-- &nbsp; --}}
